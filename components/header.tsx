...
export default function Header() {
    return (
      ...
      <div className="fixed left-0 top-0 flex w-full justify-evenly border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit ">
