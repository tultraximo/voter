...
export default function Statement(){
  return (
  <div
      className="relative max-w-5xl font-noto overflow-hidden rounded border-gray-100 border-solid
    ...
    >
      <div className="p-6 mx-auto text-2xl sm:text-5xl text-center font-bold">
